...
contract DefiPlatform is RequestFactory {
     ...
     */
    function lend(address payable _requestContractAddress) external {
     ...
     */
    function payback(address payable _requestContractAddress) external {
     ...
     * @param _requestContractAddress the address of the lendingRequest contract you want to payback debt of
     */
    function collectColletral(address payable _requestContractAddress) external {
     ...
     */
    function cancelRequest(address payable _requestContractAddress) external {
